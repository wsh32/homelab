...
terraform/diglett/             — Diglett VMs (DNS, HAOS, Infra)
terraform/machamp/             — Machamp VMs (Services, Dev)
services/diglett-dns/          — AdGuard Home + Headscale + cloudflared
services/diglett-infra/        — Traefik + step-ca + Infisical + Vaultwarden + Authentik + Litestream
