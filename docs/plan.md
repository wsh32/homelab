...
all nodes. Services on other VMs (e.g. Jellyfin on `machamp-services` at `192.168.0.30`) are
...
**Services on other VMs** (e.g. machamp-services) are configured as external backends in
